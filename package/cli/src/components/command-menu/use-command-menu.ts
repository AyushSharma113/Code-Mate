// Things this custom react hook do :
...
export function useCommandMenu(): UseCommandMenuReturn {
  ...
  const commandQuery =
    showCommandMenu && textValue.startsWith("/") ? textValue.slice(1) : ""; // gets the user query starts with this /
  ...
  // called whenever textarea changes
  ...
  // Resove a command at a specifix index (returns the command , calller handles execution )
  ...
  // Arrows keys move selection ; the list follows along when the highlight goes offscreen
  useKeyboard((key) => {
